...
const Navbar = () => {
    ...
    return (
        <div className={`transition-all duration-300 ${isScrolled ? 'fixed top-5 lg:top-0 left-0 right-0 z-50 mt-0 py-0 lg:py-2' : 'mt-5'}`}>
                    ...
                    >
                        <div className='flex flex-col h-full pt-24 px-8'>
                            ...
                            <div
                                ...
                                style={{
                                    transitionDelay: isMobileMenuOpen ? `${menuData.length * 100}ms` : '0ms'
                                }}
                            >
                                <OutlineBtn
                                    title='Connect Wallet'
